...
2. [Разрешите выполнение userscript’ов и режим разработчика](https://www.tampermonkey.net/faq.php?locale=ru#Q209) в вашем браузере.
   Проще всего через ссылку в бразуере chrome://extensions/  
   2.1 Включить переключатель в правом вехнем углу "Режим разработчика"
   2.2 Нажать на расширение tampermonkey и включить опцию "Разрешить пользовательские скрипты"
